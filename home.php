...
if(1)
{
	...
	//$profile = mysql_fetch_array(mysql_query("select photo from profiles where uid='$_SESSION[uid]'"));
...
<div class=photo><img src="<?php echo $profile[photo] ?>" alt="<?php echo $_SESSION[username]; ?>'s Photo" width=128 height=128/></div><div onClick=changePhoto() style="font-size:10px;color:blue">Change Photo</div>

<div id=photoPopup class=popup>
<form enctype="multipart/form-data" method="POST" action="upload.php">
<br>Upload Photo : <input type=file name=file_photo><br><Br>
<input type=submit value="Upload">&nbsp;&nbsp;&nbsp;<input type=button onClick=destroy() value="Close">
</form>
</div>
...
<br>
<span class=dispname>Hello <span id=dispname><?php echo $user[displayname] ?></span></span> <span id=edit><a href=# style="text-decoration:none; font-size:9px" onClick=changeDispName($("dispname").innerHTML)>Edit</a></span>
<br><br>

<img src="./images/msg.gif" />&nbsp;<i>You have <?php echo mysql_num_rows($scrap_res); ?> Messages</i>

<!-- Right pane -->
<td class=rightpane rowspan=2 valign="top" width=25%>
<div style="text-align:center; border-bottom:1px #D8DFD0 solid; padding-top:25px;">Friends List</div>
...
?>
<div style="text-align:center; border-bottom:1px #D8DFD0 solid; padding-top:50px;">Search Profiles</div>
<form method=POST action=search.php>
<br>Search : <input type=text name=simplesearch>&nbsp;<input type=submit value="Search">
</form>
<div class=seperator></div>
<center><span style="text-decoration:underline;font-size:10px;font-family:Verdana, Arial, Helvetica, sans-serif;" onClick="location.href='search.php'">Advanced Search</span></center>
<tr>

<td width=18% class=leftpane rowspan="2" valign="top">

 <div onMouseOver=changecolor(this) class=leftnav id=xyz onMouseOut=origcolor(this) onClick=loadframe("editprofile.php")>&nbsp; Edit Profile</div>
  <div onMouseOver=changecolor(this) class=leftnav id=xyz onMouseOut=origcolor(this) onClick=loadframe("picupload.php")>&nbsp; Upload Photos</div>
 <div onMouseOver=changecolor(this) class=leftnav id=xyz onMouseOut=origcolor(this) onClick=loadframe("settings.php")>&nbsp; Account Settings</div>
  <div onMouseOver=changecolor(this) class=leftnav id=xyz onMouseOut=origcolor(this) onClick="location.href='profile.php?uid=<?php echo $_SESSION[uid] ?>'">&nbsp;View Profile</div>
 <div onMouseOver=changecolor(this) class=leftnav id=xyz onMouseOut=origcolor(this) onClick="location.href='logout.php'">&nbsp; Log Out</div>

<td valign="top">
<div class=centermain id=centermain>
<div align=center style="font-size:18px;font-weight:bold">Last 5 Messages</div>
